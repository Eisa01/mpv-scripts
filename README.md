...
- **While mpv is active (running a video)**
	 ...
	 - **[ctrl]**+**[v]** when different video is copied, [ctrl]+[v] will add video into playlist to play it next
...
- **While mpv is active (running a video)**
	- **[ctrl]**+**[z]** to undo accidental seek by returning to original time and vise-versa.
